...
ARG VITE_BRAND_NAME=VOS IA
ARG VITE_BRAND_TAGLINE=Agentes inteligentes para empresas y profesionales.
ARG VITE_DEMO_COMPANY_NAME=Arándano Café Bar
ARG VITE_LANDING_WHATSAPP_URL=
ENV VITE_API_URL=$VITE_API_URL
ENV VITE_LANDING_WHATSAPP_URL=$VITE_LANDING_WHATSAPP_URL
